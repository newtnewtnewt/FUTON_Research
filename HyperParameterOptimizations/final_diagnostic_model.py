...
patientdata:pd.DataFrame = pd.read_csv("/home/dunnnm2/thesis_research/final_optimization_runs/patient_data_modified.csv")
...
def calculate_optimal_clusters_driver(data_set:pd.DataFrame, run_optimal_clusters:bool, run_multithread:bool, 
                                      show_graph:bool, thread_count:int) -> int:
    # Cluster selection
    ...
    if run_optimal_clusters:
        ...
        if run_multithread:     
            ...
            calculate_optimal_clusters(data_set=data_set, max_state_count=state_count, num_loops_per_iter=10000, 
                                max_num_iter=32)
...
def evaluate_model_accuracy(qlearning_train_final:pd.DataFrame, test_name:str, is_debug:bool, 
    ...
    total_string = (f'{run_num},{alpha},{gamma},{total_patients},{correct_guesses},'
                    f'{overall_accuracy},{dead_accuracy},{live_accuracy},'
...
"""
# PCA is a technique to perform dimensionality reduction in large featured datasets (I.E) MIMIC
...
"""
# aggregate_Q_learning_evaluation is a function that evaluates all the models
#
# Input: 
#
# Output:
